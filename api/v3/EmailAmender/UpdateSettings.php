...
function civicrm_api3_email_amender_update_settings($params) {
   // TODO why doesn't this work? _civicrm_api3_system_settings_update_safely('email_amender_enabled', $params);
    ...
    CRM_Core_BAO_Setting::setItem(mysql_real_escape_string($params['email_amender_enabled']), 'uk.org.futurefirst.networks.emailamender', 'emailamender.email_amender_enabled');
