...
<br/><br/>
{ts}This will automatically correct incorrect email addresses attached to the contacts you've selected. 
{ts}An activity will be added to each contact recording what has changed.
<br/><br/>
